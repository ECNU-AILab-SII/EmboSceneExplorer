...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            # #onlycot
            # try:
            #     conv_sources[0]['conversations'][0]['value']="<pc>\n"+conv_sources[0]['conversations'][0]['value'].split("\n")[1]+conv_sources[0]['reason']
            # except:
            #     conv_sources[0]['conversations'][0]['value']
            # try:
            #     if len(conv_sources[0]['conversations'][0]['value'])>200:
            #         conv_sources[0]['conversations'][0]['value']=conv_sources[0]['conversations'][0]['value']+"\n"+conv_sources[0]['reason']
            # except:
            #     conv_sources[0]['conversations'][0]['value']
            # ###############    
